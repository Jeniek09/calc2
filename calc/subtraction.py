"""This is the subtraction calculation that is being extended and that inherits the value A and value B from the calculation class"""
...
#This is how you extent the Subtraction class with the calculation
class Subtraction(Calculation):
    """The subtraction class has one method to get the result of the calculation A and B come
