"""This is the multiplication calculation that is being extended and that inherits the value A and value B from the calculation class"""
...
class Multiplication(Calculation):
    """The multiplication class has one method to get the result of the calculation A and B come
